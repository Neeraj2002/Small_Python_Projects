...
def init_grid(rows, cols, color):
    # So lets take an example (Intead of 50 by 50 take 4 by 4 pixel grid)
    # so in the grid list you have created we will 4 another list in which there will be tuples for each element in the row
    # [
